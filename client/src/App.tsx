				...
				<div className='sidenav-footer mx-3'>
					<div className='card card-background shadow-none card-background-mask-secondary' id='sidenavCard'>
						<div
							...
							style={{
								backgroundImage: `url(${ROOT}/assets/img/curved-images/white-curved.jpeg)`,
							}}></div>
			...
			<div className='main-content position-relative bg-gray-100 max-height-vh-100 h-100'>
						...
						<div className='collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2' id='navbar'>
							...
							<ul className='navbar-nav justify-content-end'>
								...
								<li className='nav-item dropdown pe-2 d-flex align-items-center'>
									...
									<ul className='dropdown-menu dropdown-menu-end px-2 py-3 ms-n4' aria-labelledby='dropdownMenuButton'>
										<li className='mb-2'>
				...
				<div className='container-fluid'>
					<div
						...
						style={{
							backgroundImage: `url(${ROOT}/assets/img/curved-images/curved0.jpg)`,
							...
							<div className='row align-items-center justify-content-lg-between'>
								...
								<div className='col-lg-6'>
									<ul className='nav nav-footer justify-content-center justify-content-lg-end'>
										...
										<li className='nav-item'>
											<a href='https://creative-tim.com/blog' className='nav-link text-muted' target='_blank'>
												Blog
											</a>
										</li>
										<li className='nav-item'>
			...
			<div className='fixed-plugin'>
				...
				<div className='card shadow-lg'>
					...
					<div className='card-body pt-sm-3 pt-0'>
						...
						<a className='btn bg-gradient-dark w-100' href='https://www.creative-tim.com/product/soft-ui-dashboard-pro'>
							Free Download
						</a>
						<a
